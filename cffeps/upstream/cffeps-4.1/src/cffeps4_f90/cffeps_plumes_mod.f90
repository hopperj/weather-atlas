...
! Fichier / File   : cffeps_plume_mod.ftn90
...
!
!============================================================================
module cffeps_plume_mod

   use cffeps_mod,  only: MET_LEVELS, fuel_size, met_type,          &
                          cffeps_fire_shape, cffeps_timestep,       &
                          cffeps_alpha, cffeps_sinks, msl_pressure, &
                          cffeps_fire_type
   implicit none
   public  :: cffeps_plumecalc, cffeps_plumecalc2
   private :: r_calc
...
!============================================================================
!
   subroutine cffeps_plumecalc2(met, area, Qt, mw0, perimeter, dz, mplume, Qbb)
...
!/* 3. Set array pointers to first upper air data point. */
      ...
      P0_mb = met%P(1) * 1.0e-2   !  // pressure at/near surface [mb]
