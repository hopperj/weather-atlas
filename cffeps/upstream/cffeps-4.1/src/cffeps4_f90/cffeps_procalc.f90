...
! Fichier / File   : cffeps_procalc.ftn90
...
!============================================================================
 subroutine cffeps_procalc(ifuel, fbp, t1, t2, a, p, d)
   use cffeps_mod,           only: fbp_type, cffeps_fbp_accel, &
                                   cffeps_fueltypes
   ...
   if (trim(cffeps_fueltypes(ifuel)) == "C1" .or. fbp%cfb == 0.0) then
      alpha = 0.115
   else
