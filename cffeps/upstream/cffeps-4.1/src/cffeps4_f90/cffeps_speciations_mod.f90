...
! Fichier / File   : cffeps_emiss_speciations.ftn90
...
!============================================================================
!
module cffeps_speciations_mod

  use cffeps_mod, only: cffeps_nspec
  implicit none
!
...
!
  ...
  subroutine cffeps_emiss_speciations(emiss, mj_emis, isize)
   ...
   use cffeps_mod, only: emissions_type
   implicit none
...
end module cffeps_speciations_mod
