#!/usr/bin/env python3
"""Extract frozen MINX observations only after height-blind selection."""
...
def main() -> int:
    ...
    if (
        blind.get("artifact_type") != "w3-height-blind-minx-qa-ledger"
        ...
        raise ValueError("MINX observations require a valid height-blind selection ledger")
    ...
    audit_payload = {
        ...
        "frozen_observation_count": len(observations),
